...
public class SaveAdapter extends RecyclerView.Adapter<SaveAdapter.ViewHoder> {
    ...
    public SaveAdapter(ArrayList<News> listNew, Context context) {
        this.listNew = listNew;
        this.inflater = LayoutInflater.from(context);
    }

    public SaveAdapter(ArrayList<News> list) {
        this.listNew = list;
    }
    ...
    public void onBindViewHolder(@NonNull ViewHoder holder, final int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public boolean onLongClick(View v) {
                onItemClick.onItemLongClick(position,listNew.get(position), v);
                return true;
            }
        });
    }
    ...
    public interface OnItemClick{
        ...
        void onItemLongClick(int position, News news, View view);
    }
